...
/***/ function(module, exports, __webpack_require__) {
	...
	HomeView = _backbone2.default.LayoutView.extend({
	  ...
	  initialize: function initialize() {
	    var data = (0, _jquery2.default)("#data").data("initial"),
	        flowers = new Backbone.Collection(data);

	    this.listView = new _list2.default({ collection: flowers });
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flower = __webpack_require__(9);

	var _flower2 = _interopRequireDefault(_flower);

	var _flowers = __webpack_require__(13);
	...
	ListView = _backbone2.default.CollectionView.extend({

	  template: _flowers2.default,
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _flower = __webpack_require__(10);

	var _flower2 = _interopRequireDefault(_flower);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var FlowerView = void 0;

	FlowerView = _backbone2.default.ItemView.extend({

	  template: _flower2.default,
